  ...
  function calcularResultado() {
    ...
    quiz1.addEventListener("input", calcularResultado);
      ...
      var quizScores = [
        ...
        parseFloat(quiz5.value) || 0,
        parseFloat(quiz6.value) || 0,
        parseFloat(quiz7.value) || 0,
        parseFloat(quiz8.value) || 0,
        parseFloat(quiz9.value) || 0,
        parseFloat(quiz10.value) || 0,
        parseFloat(quiz11.value) || 0,
        parseFloat(quiz12.value) || 0,
        parseFloat(quiz13.value) || 0,
        parseFloat(quiz14.value) || 0,
        parseFloat(quiz15.value) || 0,
        parseFloat(quiz16.value) || 0,
    ];
      ...
      // Remove the lowest three scores
      quizScores = quizScores.slice(3);
      
      // Calculate the total quiz score
      var totalQuizScore = quizScores.reduce(function(a, b){return a + b}, 0);
  
      var resultadoAtualizado = (((ai*0.15) + (pi*0.3) + (ai2*0.15) + (pf * 0.3)) + ((totalQuizScore * (1/13))*0.1) + (((aps1_c + aps2_c + aps3_c + aps4_c + aps5_c + aps6_c ) * (1/6))*0.1))
